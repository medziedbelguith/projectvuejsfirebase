<template>
    <div class="container">
        ...
        <div class="row">
            <div class="card" style="width: 18rem;" v-for="item in Myproducts" :key="item.name">
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <textarea class="form-control" id="exampleFormControlText" rows="3" placeholder="Description" v-model="dataProduct.description"></textarea>
